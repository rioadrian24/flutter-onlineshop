                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex" style="gap: 1rem;">
                                    @if (Storage::disk('public')->fileExists($product->image))
                                        <img src="{{ Storage::url($product->image) }}" class="d-block rounded shadow"
                                            style="width: 5rem; height: 5rem;">
                                    @else
                                        <img src="{{ $product->image }}" class="d-block rounded shadow"
                                            style="width: 5rem; height: 5rem;">
                                    @endif
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_available" value="1" class="selectgroup-input"
                                            {{ $product->is_available == '1' ? 'checked' : 'checked' }}>
